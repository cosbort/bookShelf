...
class BookAPI:
    ...
    @staticmethod
    def fetch_book_info_by_title(title: str) -> Optional[Dict]:
        """
        Recupera le informazioni del libro usando il titolo
        """
        logger.debug(f"Cercando informazioni per titolo: {title}")
